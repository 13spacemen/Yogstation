...
/obj/item/storage/box/survival/proc/wardrobe_removal()
	...
	var/list/items_to_delete = box_owner.dna?.species?.survival_box_replacements["items_to_delete"].Copy()
	var/list/new_items = box_owner.dna?.species?.survival_box_replacements["new_items"].Copy()
